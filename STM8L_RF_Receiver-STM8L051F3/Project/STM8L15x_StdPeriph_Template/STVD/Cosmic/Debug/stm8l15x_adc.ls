...
1142  0001 1e01          	ldw	x,(OFST+1,sp)
1143  0003 7b05          	ld	a,(OFST+5,sp)
...
1254  000d 1e01          	ldw	x,(OFST+1,sp)
1255  000f 7b06          	ld	a,(OFST+6,sp)
...
2137                     ; 720   tmpreg = (uint16_t)((uint16_t)((uint16_t)tmpreg << 8) | ADCx->DRL);
2139  0004 1603          	ldw	y,(OFST+1,sp)
2140  0006 97            	ld	xl,a
...
2544  0003 1e01          	ldw	x,(OFST+1,sp)
2545  0005 43            	cpl	a
...
2778  0017 1e03          	ldw	x,(OFST+1,sp)
2779  0019 43            	cpl	a
